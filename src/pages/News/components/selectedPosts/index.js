    ...
    return (
        <>
          <div className="newsSelectedPosts-wrapper">
              <h3 className="newsSelectedPosts-wrapper-head1">Selected Posts</h3>
              <h6 className="newsSelectedPosts-wrapper-head2">EDITOR'S PICKS</h6>
              <motion.div ref={customAnimation1.ref} className="newsSelectedPosts-wrapper-infoContainer">
                  <motion.div animate={customAnimation1.animation} className="newsSelectedPosts-wrapper-infoContainer-col1">
                     ...
                     <h3 className="newsSelectedPosts-wrapper-infoContainer-col1-head"><a href={details.col1headinglink}>{details.col1heading}</a></h3>
                     ...
                     <p className="newsSelectedPosts-wrapper-infoContainer-col1-para">{details.col1para}</p>

                     <div ref={headAnimation1.ref} className="newsSelectedPosts-wrapper-infoContainer-col1-bottom">
                         {details.col1bottom.map((data,index)=>(
                             <motion.div custom={index} animate={headAnimation1.animation} key={index} className="newsSelectedPosts-wrapper-infoContainer-col1-bottom-description">
                                 <div className="newsSelectedPosts-wrapper-infoContainer-col1-bottom-description-img"  style={{backgroundImage:`url(${data.bgImg})`}} >                    
                                 </div>
                                 <h3 className="newsSelectedPosts-wrapper-infoContainer-col1-bottom-description-head"><a href={data.headinglink}>{data.heading}</a></h3>
                  ...
                  <div ref={headAnimation2.ref} className="newsSelectedPosts-wrapper-infoContainer-col2">
                      {details.col2.map((data,index)=>(
                        <motion.div key={index} custom={index} animate={headAnimation2.animation} className="newsSelectedPosts-wrapper-infoContainer-col2-description">
                            <NewsLinkTag color={data.tag.color} tag={data.tag.tag} link={data.tag.link} />
                            <h3 className="newsSelectedPosts-wrapper-infoContainer-col2-description-head"><a href={data.headinglink}>{data.heading}</a></h3>
                            <AuthorDateRead author={data.dateAndTime.author} link={data.dateAndTime.link} date={data.dateAndTime.date} readTime={data.dateAndTime.readTime} color={data.dateAndTime.color} fontSize={data.dateAndTime.fontSize}  />
                        </motion.div>
                      ))}
                  ...
                  <motion.div ref={customAnimation2.ref} animate={customAnimation2.animation} className="newsSelectedPosts-wrapper-infoContainer-col3">
                      <div className="newsSelectedPosts-wrapper-infoContainer-col3-img" style={{backgroundImage:`url(${details.col3bgImg})`}} >                    
                      </div>
                      <div className="newsSelectedPosts-wrapper-infoContainer-col3-desc">
                        ...
                        <h3 className="newsSelectedPosts-wrapper-infoContainer-col3-desc-head"><a href={details.col3headinglink}>{details.col3heading}</a></h3>
