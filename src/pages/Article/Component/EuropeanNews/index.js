...
const European_News = ({details}) => {
  const customAnimation=CustomAnimation(hidden,visible,.1);
    return (
        <>

          <motion.div ref={customAnimation.ref} animate={customAnimation.animation} className="europeanNews-wrapper">
              <h3 className="europeanNews-wrapper-head1">European News</h3>
                ...
                {details.map(data=>(
                     ...
                     <div  className="europeanNews-wrapper-content">
                        <div className="europeanNews-wrapper-slide">
                          <div  className="europeanNews-wrapper-slide-img" style={{backgroundImage:`url(${data.bgImage})`}}>
                          ...
                          <h3 className="europeanNews-wrapper-slide-head"><a href={data.headinglink}>{data.heading}</a></h3>  
