          ...
          <h3 className="journalCategories-wrapper-heading"> Categories</h3>
              <div ref={headAnimation1.ref} className="journalCategories-wrapper-imgContainer">
                  {details.map(data=>(
                        ...
                        <motion.div custom={data.id} animate={headAnimation1.animation} key={data.id} className="journalCategories-wrapper-imgContainer-bgImg" style={{backgroundImage:`url(${data.bgImg})`}} >
