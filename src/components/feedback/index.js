...
import { faGrinStars,faSadCry,faMeh,faGrinAlt} from '@fortawesome/free-solid-svg-icons'
        ...
        <>
            ...
            <div className={`feedback-container ${toggle?'feedback-container-true':'feedback-container'}`}>
                ...
                <div className="feedback-container-rating">
                    <h4 className="feedback-container-rating-head">Would you like to rate this app?</h4>
