import { AiFillHeart, AiOutlineHome, AiFillTrophy } from "react-icons/ai";
import { BiGlasses } from "react-icons/bi";
import { FiKey, FiSlack } from "react-icons/fi";
import { ImBooks, ImBullhorn } from "react-icons/im";
...
import { faFacebookF,faTwitter,faInstagram,faLinkedinIn,faPinterest,faMediumM } from '@fortawesome/free-brands-svg-icons'
import { TiSocialYoutubeCircular } from 'react-icons/fa';
...
const accordion=[
  ...
  },
  {
    ...
    paragraphs:`Users that have signed up to medical pdf are able to download and upload the 
  ...
  },
  {
    ...
    paragraphs:`Remember that by this time, the user is curious, otherwise he wouldn't scroll to get here.Remember that by this time,
...
const trendingBook=[
  {
    id:1,
    bgImage:require('../../assets/images/book/book1.jpg').default,
    tag: {color:'orange', tag:'lifestyle',link:'/#456',},
    heading:'Apple’s iPhone 11 Pro battery case sports a new camera button',
    headinglink:'/head',
    dateAndTime:{date:'December 10,2019' ,readTime:'5 Min read'  ,color:'#9f9f9f' ,fontSize:'12px'},
...
const newsDetailNavigationLinksDetails=
 ...
 const bookTrendingDetails=[
   {
     id:1,
     bookImg:require('../../assets/images/book/book1.jpg'),
   ...
   {
    id:2,
    bookImg:require('../../assets/images/book/book2.png'),
    title:'Principles of Genetics',
    authorInfo:'by D. Peter Snustad  (Author), Michael J. Simmons (Author)',
    rating:'4.0',
    views:'5K Views',
 ...
 const bookSuggestionDetails=[
  {
    id:1,
    bookImg:require('../../assets/images/book/book1.jpg').default,
    title:'Principles of Genetics',
    authorInfo:'by D. Peter Snustad  (Author), Michael J. Simmons (Author)',
    rating:'4.0',
  },
  {
   id:2,
   bookImg:require('../../assets/images/book/book2.png').default,
   title:'Principles of Genetics',
   authorInfo:'by D. Peter Snustad  (Author), Michael J. Simmons (Author)',
   rating:'4.0',
 },
