    ...
    return (
        <>
           ...
           <div className={`featureBlogCard-container-wrapper`}>
                    <img className="featureBlogCard-container-wrapper-picture" alt='img' src={require("../../../assets/images/card1.png")?.default} />
                    ...
                    <div className={`featureBlogCard-container-wrapper-footer`}>
                        <div className="featureBlogCard-container-wrapper-footer-user-info">
                            <img className="featureBlogCard-container-wrapper-footer-user-info-picture" alt="img" src={require("../../../assets/images/profile1.png")?.default} />
