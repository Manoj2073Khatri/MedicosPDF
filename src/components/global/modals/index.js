    ...
    return (
        <>
            <div className={`modals-${activeColor}`}>
                <button className="textM" onClick={() => clear()}>{type}</button>
            </div>
                ...
                <div className={`${type}-containerN ${checktrue ? `${type}-container` : ''}`}>
                    <div className={`${type}-container-wrapper`}>
                        <div className={`${type}-container-wrapper-top`}>
                            ...
                            <FontAwesomeIcon icon={faTimes} className={`${type}-container-wrapper-top-icon`} onClick={() => clear()} />
                        </div>
                        ...
                        <div className={`${type}-container-wrapper-bottom`}>
                            ...
                            <span className={`${type}-container-wrapper-bottom-p`} onClick={() => clear()}>close</span>
                        </div>
                    </div>
                </div>
                :
                ...
                <div className={`${type}-containerN ${checktrue ? `${type}-container` : ''}`}>
                    <div className={`${type}-container-wrapper`}>
                        ...
                        <div className={`${type}-container-wrapper-bottom`}>
                            ...
                            <button className={`${type}-container-wrapper-bottom-btn2`} onClick={() => clear()}>CLOSE</button>
                        </div>
                    </div>
                </div>
                :
            ...
            {formmodal ?
                ...
                <div id={type} className={`${type}-containerN ${checktrue ? `${type}-container` : ''}`} onClick={(e) => closeModal(e)}>
                    <div className={`${type}-container-wrapper`}>
                        <div className={`${type}-container-wrapper-top`}>
